var cruminaAjaxBlog = {
    ...
    addEventListeners: function () {
        ...
        this.$reactions.on( 'click', function ( event ) {
            ...
            _this.removeQueryStringParameter( 'page' );
            _this.getPosts();
        } );
        ...
        this.$nav.on( 'click', 'li.page-item:not(.disabled) > a', function ( event ) {
            event.preventDefault();
            var $self = jQuery( this );
            var page = $self.attr( 'href' ).match( /\d+$/ );

            if ( !page[0] || page[0] == 1 ) {
                _this.removeQueryStringParameter( 'page' );
            } else {
                _this.updateQueryStringParameter( 'page', page );
            }

            _this.getPosts();
        } );

        this.$nav.on( 'click', 'a.btn-more', function ( event ) {
            event.preventDefault();
            var page = _this.getQueryStringParameter( 'page' );
            page = page ? page : 1;
    ...
    resetFilters: function ( ) {
        ...
        this.removeQueryStringParameter( 'page' );
    ...
    getPosts: function () {
        ...
        jQuery.ajax( {
            ...
            data: {
                ...
                page: _this.getQueryStringParameter( 'page' ),
